...
<body class="min-h-screen bg-gradient-to-br from-green-100 to-green-300 
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="email" type="email" name="email" 
                    ...
                    class="mt-1 w-full rounded-lg border border-gray-300 
                           px-4 py-2 focus:ring-2 focus:ring-green-400 
            ...
            <button type="submit"
                class="w-full bg-green-600 hover:bg-green-700 
                       ...
                       py-2.5 rounded-xl transition duration-300 shadow-md">
                Login
            </button>
        </form>
