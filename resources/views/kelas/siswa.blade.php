...
<div class="relative bg-cover bg-center bg-fixed"
     style="background-image: url('{{ asset('images/kelas.jpeg') }}');">
    ...
    <div class="relative z-10">
        ...
        {{-- ================= SECTION QUOTES PUTIH ================= --}}
        <section id="quotes-section" class="py-20 bg-white text-center">
            <div class="max-w-4xl mx-auto px-4">
        
                <h2 class="text-3xl font-bold mb-6">
                    Dari Kami {{ $kelas->nama_kelas }}
                </h2>
